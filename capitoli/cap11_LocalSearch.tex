...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{immagini/LocalSearch/state_flipping.png}
...
\begin{itemize}
    ...
    $$ \Phi(S') \ge \Phi(S) + 1 $$
\end{itemize}
Poiché la funzione $\Phi$ è limitata superiormente e cresce strettamente ad ogni passo, l'algoritmo deve terminare al più in un numero finito di passi $W$.
