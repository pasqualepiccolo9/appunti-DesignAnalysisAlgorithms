...
\clearpage
\noindent
Si noti che un grafo orientato può avere più di un ordinamento topologico (come mostrato in Figura \ref{fig:ex_TopologicalSorting}), e che un ordinamento topologico esiste se e solo se il grafo orientato è aciclico.
