...
\section{Altezza di un Red-Black Tree}
L'altezza di un Red-Black Tree con $n$ nodi è $O(\log n)$.
...
\section{Insert}
Per inserire un nuovo nodo in un Red-Black Tree si procede come in un normale BST:
\begin{itemize}[nosep]
