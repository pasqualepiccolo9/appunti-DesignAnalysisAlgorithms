...
\begin{itemize}
    ...
    \item \textbf{Archi in avanti (\emph{forward edges}):} Per ogni arco $e = (u, v) \in E$ tale che $f(e) < c_e$, includiamo in $G_f$ l'arco $e' = (u, v)$ con capacità residua: $$c_f(e') = c_e - f(e)$$ \emph{Spiegazione:} Questi archi rappresentano la disponibilità residua del canale. Indicano che è possibile spingere ulteriori $c_e - f(e)$ unità di flusso da $u$ a $v$ senza violare la capacità originale.
    \item \textbf{Archi all'indietro (\emph{backward edges}):} Per ogni arco $e = (u, v) \in E$ tale che $f(e) > 0$, includiamo in $G_f$ l'arco inverso $e' = (v, u)$ con capacità residua: $$c_f(e') = f(e)$$\emph{Spiegazione:} Questi archi rappresentano la possibilità di "annullare" fino a $f(e)$ unità di flusso precedentemente inviate, spingendo flusso all'indietro.
\end{itemize}
