...
\cleardoublepage
\input{capitoli/cap2_BST}

\cleardoublepage
\input{capitoli/cap3_AVL}

\cleardoublepage
\input{capitoli/cap4_MWST}

\cleardoublepage
\input{capitoli/cap5_RBT}

\cleardoublepage
\input{capitoli/cap6_HashTables}

\cleardoublepage
\input{capitoli/cap7_PriorityQueues}

\cleardoublepage
\input{capitoli/cap8_PatternMatching}

\cleardoublepage
\input{capitoli/cap9_Tries}

\cleardoublepage
\input{capitoli/cap10_Greedy}

\cleardoublepage
\input{capitoli/cap11_DynamicProgramming}

\cleardoublepage
\input{capitoli/cap12_LocalSearch}

\cleardoublepage
\input{capitoli/cap13_Graphs}

\cleardoublepage
\input{capitoli/cap14_GraphsTraversal}

\cleardoublepage
\input{capitoli/cap15_TransitiveClosure}

\cleardoublepage
\input{capitoli/cap16_DAG}

\cleardoublepage
\input{capitoli/cap17_ShortestPaths}

\cleardoublepage
\input{capitoli/cap18_MST}

\cleardoublepage
\input{capitoli/cap19_NetworkFlow}
