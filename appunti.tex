...
% --- USO DELLO STILE ---
\lstset{style=dracula}  % applica lo stile Dracula a tutti i blocchi \begin{lstlisting}
...
\cleardoublepage
\input{capitoli/cap7_PatternMatching}

\cleardoublepage
\input{capitoli/cap8_Tries}

\cleardoublepage
\input{capitoli/cap9_Greedy}

\cleardoublepage
\input{capitoli/cap10_DynamicProgramming}
